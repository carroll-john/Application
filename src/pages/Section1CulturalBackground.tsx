    ...
    >
      <div className="grid gap-6">
        <FormSectionCard
          ...
          icon={<Languages className="mt-0.5 h-6 w-6 shrink-0 text-[#1f2a3a]" />}
        ...
        <FormSectionCard
          className="rounded-[30px] border-slate-200 p-5 sm:p-6"
          icon={<Users className="mt-0.5 h-6 w-6 shrink-0 text-[#1f2a3a]" />}
        ...
        <FormSectionCard
          className="rounded-[30px] border-slate-200 p-5 sm:p-6"
          icon={<BookOpen className="mt-0.5 h-6 w-6 shrink-0 text-[#1f2a3a]" />}
