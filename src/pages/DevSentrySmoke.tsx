  ...
  return (
    <div className="min-h-screen bg-[#f7f7f4]">
      <AppBrandHeader showApplicantProfileLink={false}>
        <Link
          className="inline-flex rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-[#1f2a3a] transition-colors hover:border-[#1f2a3a]/60 hover:bg-[#F2F8FB]"
          to="/"
        >
          Back to app
        </Link>
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-6 px-4 py-8 sm:px-6 lg:px-8">
        <div className="space-y-3">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#1f2a3a]">
            Development only
          </p>
