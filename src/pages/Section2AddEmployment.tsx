      ...
      <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        ...
        <div className="space-y-6">
          <FormSectionCard
            ...
            icon={<Building className="mt-0.5 h-6 w-6 shrink-0 text-[#1f2a3a]" />}
          ...
          <FormSectionCard
            ...
            icon={<Briefcase className="mt-0.5 h-6 w-6 shrink-0 text-[#1f2a3a]" />}
            title="Role Details"
          >
          ...
          >
            ...
            <textarea
              className="min-h-40 w-full rounded-2xl border border-slate-300 px-4 py-3 text-base outline-none transition focus:border-[#1f2a3a] focus:ring-4 focus:ring-[#1f2a3a]/10"
              placeholder={
