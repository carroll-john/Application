...
export default function AIAssessmentDemo({
  ...
  return (
    <ModalShell
      ...
      header={
        <div className="flex items-start justify-between bg-[#1f2a3a] px-6 py-5 text-white">
          <div>
    ...
    >
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <SurfaceCard className="rounded-[28px] border-0 bg-[#1f2a3a] p-5 text-white shadow-none">
