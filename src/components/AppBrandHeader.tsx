    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <a className="transition-colors hover:text-white" href={UC_LINKS.accessibility}>
              Accessibility and language
            </a>
            <span aria-hidden="true" className="text-white/45">|</span>
            <a className="transition-colors hover:text-white" href={UC_LINKS.safeCommunity}>
              Safe Community
            </a>
          </nav>
          <span className="font-medium sm:hidden">UC pilot assessment</span>
          <nav aria-label="University quick links" className="ml-auto flex items-center gap-4">
            <a
            ...
            <span className="font-medium text-white">Pilot assessment</span>
          </nav>
        </div>
      </div>
      ...
      <div className="border-b border-[var(--brand-header-border)] shadow-[var(--brand-header-shadow)]">
        ...
        >
          <NavLink
            aria-label="University of Canberra – go to course discovery"
          ...
          <nav
            aria-label="UC pilot navigation"
