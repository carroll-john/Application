 ...
 * so action buttons stay anchored and content does not flash empty.
 */
  ...
  return (
    ...
    >
      <div className="rounded-lg border border-[var(--info-border)] bg-white p-4 sm:p-5">
        ...
        <div className="mt-3 h-3 w-full max-w-2xl animate-pulse rounded bg-slate-100" />
        <div className="mt-2 h-3 max-w-xl animate-pulse rounded bg-slate-100" />
        <div className="mt-4 h-24 animate-pulse rounded-md bg-slate-50" />
      </div>
      ...
      <div className="space-y-6">
        {[0, 1, 2].map((index) => (
          ...
          >
            ...
            <div className="mt-4 h-14 animate-pulse rounded-md bg-slate-50" />
          </div>
        ))}
      </div>
    </div>
