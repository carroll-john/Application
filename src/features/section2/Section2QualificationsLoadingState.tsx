...
export function Section2QualificationsLoadingState() {
  return (
    ...
    >
      <div className="content-block-compact rounded-lg border border-[var(--info-border)] bg-white p-4 sm:p-5">
      ...
      <div className="space-y-6">
        {[0, 1, 2].map((index) => (
          <div
            key={index}
            className="content-block rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6"
          >
