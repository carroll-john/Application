...
- Matched-course card CTAs shortlist courses until exactly three are selected. The third selection reveals one shared assessment prompt; sign-in precedes the transcript field. Completed results are embedded in the three selected cards as side-by-side "Original" versus "After credit" duration and 2026 indicative tuition. Assessed cards hide the provisional CV-only credit-potential section and do not repeat the guide-only boundary already shown above the cards. A zero-credit result retains its faculty-review status without a second summary sentence beneath the comparison. Before assessment, and for non-selected cards, the existing entry and credit-potential guidance remains visible.
