...
- Non-form surfaces (course discovery, CV-match, course details, overview, dashboard, submitted) keep vertical rhythm compact so key content reaches the viewport with less scrolling. Application form shells and step wrappers are excluded from that density pass.
