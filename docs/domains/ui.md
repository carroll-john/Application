...
- The UC desktop header pairs the official UC logo with the compact teal “Powered by KeypathTECH” service mark: white copy, a cyan segmented ring centred on the K, regular “Keypath” and bold “TECH”. The mark stays hidden in the compact mobile header, and the StudyNext header remains unchanged.
