...
- The synthetic Bill Shorten UC demonstration has one identity-and-transcript-gated credit fixture: the Monash University Bachelor of Arts and Bachelor of Laws transcript indicates 6 credit points for Master of Education (Leadership) and Master of Education (STEM), while Graduate Certificate in Educational Leadership remains on faculty review. All other applicants, transcripts and courses use the ordinary evidence-based assessment.
